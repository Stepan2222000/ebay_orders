...
DESC_TEXT_CAP = 3000
PROMPT_REV = "v1"         # входит в отпечаток: смена промпта = новый вход
...
- qty_note: the buyer's order(s) were for {order_qtys} unit(s) of this listing. Note ONLY a real inconsistency between order quantity and what one lot contains; empty string otherwise.
